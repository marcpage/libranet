...
Each session should make minimal changes to existing code to accomplish the task.

All python imports should import each symbol from the module instead of importing entire modules.
