...
:mod:`libranet.unbundler.module`), for request threads to answer from.
"""
...
class WebServerModule(ModuleBase):
    ...
    subscriptions: ClassVar[frozenset[EventType]] = frozenset({EventType.APP_PATH_RESOLVED})
    ...
    def handle(self, message: Message) -> None:
        """Remember what the unbundler found at a path, unless it stored the file.
